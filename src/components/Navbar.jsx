  ...
  return (
    <div className='glass rounded-2xl px-4 md:px-6 py-3'>
      ...
      <div className='flex md:hidden justify-between items-center'>
        ...
        {open ? (
          <HiMenuAlt3 className='text-accent-cyan w-9 h-9 cursor-pointer' onClick={toggle} />
        ) : (
          <HiMenuAlt1 className='text-accent-cyan w-9 h-9 cursor-pointer' onClick={toggle} />
        )}
      </div>
